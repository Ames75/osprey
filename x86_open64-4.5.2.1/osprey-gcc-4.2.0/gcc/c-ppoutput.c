  ...
  for (;;)
	...
	putc (' ', print.outf);
	  ...
	  maybe_print_line (token->src_loc);
          if (token->val.pragma  == PRAGMA_OMP_ATOMIC)
	      fputs ("#pragma omp atomic ", print.outf);
          else if (token->val.pragma  == PRAGMA_OMP_BARRIER)
	      fputs ("#pragma omp barrier ", print.outf);
          else if (token->val.pragma  == PRAGMA_OMP_CRITICAL)
	      fputs ("#pragma omp critical ", print.outf);
          else if (token->val.pragma  == PRAGMA_OMP_FLUSH)
	      fputs ("#pragma omp flush ", print.outf);
          else if (token->val.pragma  == PRAGMA_OMP_FOR)
	      fputs ("#pragma omp for ", print.outf);
          else if (token->val.pragma  == PRAGMA_OMP_MASTER)
	      fputs ("#pragma omp master ", print.outf);
          else if (token->val.pragma  == PRAGMA_OMP_ORDERED)
	      fputs ("#pragma omp ordered ", print.outf);
          else if (token->val.pragma  == PRAGMA_OMP_PARALLEL)
	      fputs ("#pragma omp parallel ", print.outf);
          else if (token->val.pragma  == PRAGMA_OMP_SECTION)
	      fputs ("#pragma omp section ", print.outf);
          else if (token->val.pragma  == PRAGMA_OMP_SECTIONS)
	      fputs ("#pragma omp sections ", print.outf);
          else if (token->val.pragma  == PRAGMA_OMP_SINGLE)
	      fputs ("#pragma omp single ", print.outf);
          else if (token->val.pragma  == PRAGMA_OMP_THREADPRIVATE)
	      fputs ("#pragma omp threadprivate ", print.outf);
          else
