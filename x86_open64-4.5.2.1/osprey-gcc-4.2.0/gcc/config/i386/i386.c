...
static void ix86_init_bm_builtins (void); 
...
static void ix86_init_f16c_builtins (void);
...
ix86_handle_option (size_t code, const char *arg ATTRIBUTE_UNUSED, int value)
{
  switch (code)
      ...
      if (!value)
       {
         ...
         target_flags_explicit |= MASK_BMI;
       }
       return true;
    ...
    case OPT_mtbm:
      if (!value)
       {
         target_flags &= ~MASK_TBM;
         target_flags_explicit |= MASK_TBM;
       }
       return true;
...
#define MAX_CODE_ALIGN 16
  ...
  const processor_alias_table[] =
    {
      ...
      {"barcelona", PROCESSOR_AMDFAM10, PTA_MMX | PTA_PREFETCH_SSE | PTA_3DNOW
                                       ...
                                       | PTA_SSE2 | PTA_SSE3 | PTA_POPCNT
                                       | PTA_ABM | PTA_SSE4A | PTA_CX16},
      {"bdver2",    PROCESSOR_BDVER2, PTA_MMX | PTA_PREFETCH_SSE | PTA_3DNOW
                                       | PTA_64BIT | PTA_3DNOW_A | PTA_SSE
                                       | PTA_SSE2 | PTA_SSE3 | PTA_POPCNT
                                       | PTA_ABM | PTA_SSE4A | PTA_CX16
				       | PTA_BMI | PTA_TBM },
  ...
  /* Turn on BM builtins for -mbmi and tbm. */
  if (TARGET_BMI)
    target_flags |= MASK_BMI;
...
ix86_init_builtins (void)
{
  ...
  if (TARGET_BMI || TARGET_TBM)
    ix86_init_bm_builtins ();
  if (TARGET_F16C)
    ix86_init_f16c_builtins ();
}
...
ix86_init_avx_builtins (void)
{
  ...
  tree void_ftype_v8sf
    = build_function_type (V8SF_type_node, void_list_node);
    
  tree void_ftype_v4df
    = build_function_type (V4DF_type_node, void_list_node);
    
  tree void_ftype_v4di
    = build_function_type (V4DI_type_node, void_list_node);

  tree void_ftype_v8sf_double_type = 
               build_function_type_list 
      (V4DF_type_node, double_type_node, double_type_node, double_type_node, double_type_node, NULL_TREE);

/* There are bunch of existing builtins for AVX/FMA4/XOP. 
 * These builtins are supported in newer version of gcc(version 4.6.0). 
 * The newer version of gcc also contains three new header files avxintrin.h, 
 * fam4intrin.h and xopintrin.h.These files contain definition of the 
 *  intrinsics that we want to implement.  
 * The definitions are in two forms, viz.,
 *  1. As an inline function that calls the already implemented builtin function 
 *  2. As a macro that expands to a call to the already implemented builtin function 
 * An example from avxintrin.h is as below:
  extern __inline __m256d __attribute__((__gnu_inline__, __always_inline__, __artificial__)  ) __mm256_add_pd (__m256d __A, __m256d __B)
   {
     return (__m256d) __builtin_ia32_addpd256 ((__v4df)__A, (__v4df)__B);
   }

 * In the above code, "__mm256_add_pd" is the new intrinsic that is being added.
 * However, this actually maps to the builtin "__builtin_ia32_addpd256".
 * Here you see an inline call to the builtin "__builtin_ia32_addpd256".
 * What we need to do is to create a new builtin named "__mm256_add_pd" 
 * which internally generates the same instruction as the intrinsic 
 * "__builtin_ia32_addpd256" would generate. */

  /* AVX builtins */
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__builtin_ia32_addpd256",
                   v4df_ftype_v4df_v4df, IX86_BUILTIN_ADDPD256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_add_pd",
                   v4df_ftype_v4df_v4df, IX86_BUILTIN_ADDPD256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__builtin_ia32_addps256",
                   v8sf_ftype_v8sf_v8sf, IX86_BUILTIN_ADDPS256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_add_ps",
                   v8sf_ftype_v8sf_v8sf, IX86_BUILTIN_ADDPS256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__builtin_ia32_addsubpd256",
                   v4df_ftype_v4df_v4df, IX86_BUILTIN_ADDSUBPD256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_addsub_pd",
                   v4df_ftype_v4df_v4df, IX86_BUILTIN_ADDSUBPD256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__builtin_ia32_addsubps256",
                   v8sf_ftype_v8sf_v8sf, IX86_BUILTIN_ADDSUBPS256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_addsub_ps",
                   v8sf_ftype_v8sf_v8sf, IX86_BUILTIN_ADDSUBPS256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__builtin_ia32_andnpd256",
                   v4df_ftype_v4df_v4df, IX86_BUILTIN_ANDNPD256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_andnot_pd",
                   v4df_ftype_v4df_v4df, IX86_BUILTIN_ANDNPD256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__builtin_ia32_andnps256",
                   v8sf_ftype_v8sf_v8sf, IX86_BUILTIN_ANDNPS256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_andnot_ps",
                   v8sf_ftype_v8sf_v8sf, IX86_BUILTIN_ANDNPS256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__builtin_ia32_andpd256",
                   v4df_ftype_v4df_v4df, IX86_BUILTIN_ANDPD256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_and_pd",
                   v4df_ftype_v4df_v4df, IX86_BUILTIN_ANDPD256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__builtin_ia32_andps256",
                   v8sf_ftype_v8sf_v8sf, IX86_BUILTIN_ANDPS256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_and_ps",
                   v8sf_ftype_v8sf_v8sf, IX86_BUILTIN_ANDPS256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__builtin_ia32_blendpd256",
                   v4df_ftype_v4df_v4df_int, IX86_BUILTIN_BLENDPD256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_blend_pd",
                   v4df_ftype_v4df_v4df_int, IX86_BUILTIN_BLENDPD256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__builtin_ia32_blendps256",
                   v4df_ftype_v4df_v4df_int, IX86_BUILTIN_BLENDPD256);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_blend_ps",
  ...
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_insertf128_pd",
                   v4df_ftype_v4df_v2df_int, IX86_BUILTIN_VINSERTF128PD256);
  ...
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_insertf128_ps",
                   v8sf_ftype_v8sf_v4sf_int, IX86_BUILTIN_VINSERTF128PS256);
  ...
  tree ftype = 
       build_function_type_list (V8SF_type_node,
                               ...
                               float_type_node, float_type_node, 
                                                          NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_set_ps",
                   ftype, IX86_BUILTIN_SET_PS);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_setr_ps",
                   ftype, IX86_BUILTIN_SETR_PS);
  ftype = 
       build_function_type_list (V8SI_type_node,
                               ...
                               integer_type_node, integer_type_node, 
                                                          NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_set_epi32",
                   ftype, IX86_BUILTIN_SET_EPI32);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_setr_epi32",
                   ftype, IX86_BUILTIN_SETR_EPI32);
  ftype = 
       build_function_type_list (V8SI_type_node,
                               ...
                               short_integer_type_node, short_integer_type_node, 
                                                          NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_set_epi16",
                   ftype, IX86_BUILTIN_SET_EPI16);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_setr_epi16",
                   ftype, IX86_BUILTIN_SETR_EPI16);
  ftype = 
       build_function_type_list (V8SI_type_node,
                    char_type_node, char_type_node, char_type_node, char_type_node,
                    char_type_node, char_type_node, char_type_node, char_type_node,
                    char_type_node, char_type_node, char_type_node, char_type_node,
                    char_type_node, char_type_node, char_type_node, char_type_node,
                    char_type_node, char_type_node, char_type_node, char_type_node,
                    ...
                    char_type_node, char_type_node, char_type_node, char_type_node,
                                                          NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_set_epi8",
                   ftype, IX86_BUILTIN_SET_EPI8);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_setr_epi8",
                   ftype, IX86_BUILTIN_SETR_EPI8);
  ftype = 
       build_function_type_list (V8SI_type_node,
                          long_long_integer_type_node, long_long_integer_type_node, 
                          long_long_integer_type_node, long_long_integer_type_node, 
                                                          NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_set_epi64x",
                   ftype, IX86_BUILTIN_SET_EPI64X);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_setr_epi64x",
                   ftype, IX86_BUILTIN_SETR_EPI64X);

  ftype = 
       build_function_type_list (V4DF_type_node, double_type_node, NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_set1_pd",
                   ftype, IX86_BUILTIN_SET1_PD);
  ftype = 
       build_function_type_list (V8SF_type_node, float_type_node, NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_set1_ps",
                   ftype, IX86_BUILTIN_SET1_PS);
  ftype = 
       build_function_type_list (V8SI_type_node, integer_type_node, NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_set1_epi32",
                   ftype, IX86_BUILTIN_SET1_EPI32);
  ftype = 
       build_function_type_list (V8SI_type_node, short_integer_type_node, NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_set1_epi16",
                   ftype, IX86_BUILTIN_SET1_EPI16);
  ftype = 
       build_function_type_list (V8SI_type_node, char_type_node, NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_set1_epi8",
                   ftype, IX86_BUILTIN_SET1_EPI8);
  ftype = 
       build_function_type_list (V8SI_type_node, long_long_integer_type_node, NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_set1_epi64x",
                   ftype, IX86_BUILTIN_SET1_EPI64X);
  ftype = 
       build_function_type_list (V8SF_type_node, V4DF_type_node, NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_castpd_ps",
                   ftype, IX86_BUILTIN_CASTPDPS);
  ftype = 
       build_function_type_list (V8SI_type_node, V4DF_type_node, NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_castpd_si256",
                   ftype, IX86_BUILTIN_CASTPDSI);
  ftype = 
       build_function_type_list (V4DF_type_node, V8SF_type_node,NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_castps_pd",
                   ftype, IX86_BUILTIN_CASTPSPD);
  ftype = 
       build_function_type_list (V8SI_type_node, V8SF_type_node, NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_castps_si256",
                   ftype, IX86_BUILTIN_CASTPSSI);
  ftype = 
       build_function_type_list (V8SF_type_node, V8SI_type_node, NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_castsi256_ps",
                   ftype, IX86_BUILTIN_CASTSIPS);
  ftype = 
       build_function_type_list (V4DF_type_node, V8SI_type_node, NULL_TREE);
  def_isa_builtin (OPTION_MASK_ISA_AVX, "__mm256_castsi256_pd",
                   ftype, IX86_BUILTIN_CASTSIPD);
}
...
ix86_init_f16c_builtins (void)
{
  ...
  tree v8sf_ftype_v8hi
    = build_function_type_list (V8SF_type_node,
                                V8HI_type_node, NULL_TREE);
  tree v2di_ftype_v4sf_int
    = build_function_type_list (V2DI_type_node,
                                V4SF_type_node, integer_type_node, NULL_TREE);
  tree v2di_ftype_v8sf_int
    = build_function_type_list (V2DI_type_node,
                                V8SF_type_node, integer_type_node, NULL_TREE);

  def_isa_builtin (OPTION_MASK_ISA_F16C, "__builtin_ia32_vcvtph2ps",
               v4sf_ftype_v8hi, IX86_BUILTIN_CVTPH2PS);
  def_isa_builtin (OPTION_MASK_ISA_F16C, "__mm_cvtph_ps",
               v4sf_ftype_v8hi, IX86_BUILTIN_CVTPH2PS);
  def_isa_builtin (OPTION_MASK_ISA_F16C, "__builtin_ia32_vcvtph2ps256",
               v8sf_ftype_v8hi, IX86_BUILTIN_CVTPH2PS256);
  def_isa_builtin (OPTION_MASK_ISA_F16C, "__mm256_cvtph_ps",
               v8sf_ftype_v8hi, IX86_BUILTIN_CVTPH2PS256);
  def_isa_builtin (OPTION_MASK_ISA_F16C, "__builtin_ia32_vcvtps2ph",
               v2di_ftype_v4sf_int, IX86_BUILTIN_CVTPS2PH);
  def_isa_builtin (OPTION_MASK_ISA_F16C, "__mm_cvtps_ph",
               v2di_ftype_v4sf_int, IX86_BUILTIN_CVTPS2PH);
  def_isa_builtin (OPTION_MASK_ISA_F16C, "__builtin_ia32_vcvtps2ph256",
               v2di_ftype_v8sf_int, IX86_BUILTIN_CVTPS2PH256);
  def_isa_builtin (OPTION_MASK_ISA_F16C, "__mm256_cvtps_ph",
               v2di_ftype_v8sf_int, IX86_BUILTIN_CVTPS2PH256);
}
...
/* Set up all the BM (BMI + TBM) intrinsic,
   this function is called by ix86_init_builtins() */
static void
ix86_init_bm_builtins ()
{
  tree uint_ftype_uint
    = build_function_type_list (unsigned_type_node,
                                unsigned_type_node, NULL_TREE);
  tree ulli_ftype_ulli
    = build_function_type_list (long_long_unsigned_type_node,
                                long_long_unsigned_type_node, NULL_TREE);
  tree uint_ftype_uint_uint
    = build_function_type_list (unsigned_type_node,
                               unsigned_type_node, unsigned_type_node, NULL_TREE);
  tree sint_ftype_sint
    = build_function_type_list (short_unsigned_type_node,
                               short_unsigned_type_node, NULL_TREE);
  tree ulli_ftype_ulli_ulli
    = build_function_type_list (long_long_unsigned_type_node,
                               long_long_unsigned_type_node, long_long_unsigned_type_node, NULL_TREE);

  tree ulli_ftype_ulli_uint
    = build_function_type_list (long_long_unsigned_type_node,
                                long_long_unsigned_type_node, unsigned_type_node, NULL_TREE);

  /* tbm intrinsic */
  def_builtin (MASK_TBM, "__builtin_ia32_blcfill32",
               uint_ftype_uint, IX86_BUILTIN_BLCFILL32);

  def_builtin (MASK_TBM, "__builtin_ia32_blcfill64",
               ulli_ftype_ulli, IX86_BUILTIN_BLCFILL64);

  def_builtin (MASK_TBM, "__builtin_ia32_blci32",
               uint_ftype_uint, IX86_BUILTIN_BLCI32);

  def_builtin (MASK_TBM, "__builtin_ia32_blci64",
               ulli_ftype_ulli, IX86_BUILTIN_BLCI64);

  def_builtin (MASK_TBM, "__builtin_ia32_blcic32",
               uint_ftype_uint, IX86_BUILTIN_BLCIC32);

  def_builtin (MASK_TBM, "__builtin_ia32_blcic64",
               ulli_ftype_ulli, IX86_BUILTIN_BLCIC64);

  def_builtin (MASK_TBM, "__builtin_ia32_blcmsk32",
               uint_ftype_uint, IX86_BUILTIN_BLCMSK32);

  def_builtin (MASK_TBM, "__builtin_ia32_blcmsk64",
               ulli_ftype_ulli, IX86_BUILTIN_BLCMSK64);

  def_builtin (MASK_TBM, "__builtin_ia32_blcs32",
               uint_ftype_uint, IX86_BUILTIN_BLCS32);

  def_builtin (MASK_TBM, "__builtin_ia32_blcs64",
               ulli_ftype_ulli, IX86_BUILTIN_BLCS64);

  def_builtin (MASK_TBM, "__builtin_ia32_blsfill32",
               uint_ftype_uint, IX86_BUILTIN_BLSFILL32);

  def_builtin (MASK_TBM, "__builtin_ia32_blsfill64",
               ulli_ftype_ulli, IX86_BUILTIN_BLSFILL64);

  def_builtin (MASK_TBM, "__builtin_ia32_blsic32",
               uint_ftype_uint, IX86_BUILTIN_BLSIC32);

  def_builtin (MASK_TBM, "__builtin_ia32_blsic64",
               ulli_ftype_ulli, IX86_BUILTIN_BLSIC64);

  def_builtin (MASK_TBM, "__builtin_ia32_t1mskc32",
               uint_ftype_uint, IX86_BUILTIN_T1MSKC32);

  def_builtin (MASK_TBM, "__builtin_ia32_t1mskc64",
               ulli_ftype_ulli, IX86_BUILTIN_T1MSKC64);

  def_builtin (MASK_TBM, "__builtin_ia32_tzmsk32",
               uint_ftype_uint, IX86_BUILTIN_TZMSK32);

  def_builtin (MASK_TBM, "__builtin_ia32_tzmsk64",
               ulli_ftype_ulli, IX86_BUILTIN_TZMSK64);

  def_builtin (MASK_TBM, "__builtin_ia32_bextr32_imm",
               uint_ftype_uint_uint, IX86_BUILTIN_BEXTRI32);

  def_builtin (MASK_TBM, "__builtin_ia32_bextr64_imm",
               ulli_ftype_ulli_uint, IX86_BUILTIN_BEXTRI64);

  /* BMI Intrinsics */
  def_builtin (MASK_BMI, "__builtin_ia32_bextr32",
               uint_ftype_uint_uint, IX86_BUILTIN_BEXTR32);

  def_builtin (MASK_BMI, "__builtin_ia32_andn32",
               uint_ftype_uint_uint, IX86_BUILTIN_ANDN32);

  def_builtin (MASK_BMI, "__builtin_ia32_bextr64",
               ulli_ftype_ulli_uint, IX86_BUILTIN_BEXTR64);

  def_builtin (MASK_BMI, "__builtin_ia32_andn64",
               ulli_ftype_ulli_ulli, IX86_BUILTIN_ANDN64);

  def_builtin (MASK_BMI, "__builtin_ia32_blsi32",
               uint_ftype_uint, IX86_BUILTIN_BLSI32);

  def_builtin (MASK_BMI, "__builtin_ia32_blsi64",
               ulli_ftype_ulli, IX86_BUILTIN_BLSI64);

  def_builtin (MASK_BMI, "__builtin_ia32_blsmsk32",
               uint_ftype_uint, IX86_BUILTIN_BLSMSK32);

  def_builtin (MASK_BMI, "__builtin_ia32_blsmsk64",
               ulli_ftype_ulli, IX86_BUILTIN_BLSMSK64);

  def_builtin (MASK_BMI, "__builtin_ia32_blsr32",
               uint_ftype_uint, IX86_BUILTIN_BLSR32);

  def_builtin (MASK_BMI, "__builtin_ia32_blsr64",
               ulli_ftype_ulli, IX86_BUILTIN_BLSR64);

  def_builtin (MASK_BMI, "__builtin_ia32_lzcnt16",
               sint_ftype_sint, IX86_BUILTIN_LZCNT16);

  def_builtin (MASK_BMI, "__builtin_ia32_lzcnt32",
               uint_ftype_uint, IX86_BUILTIN_LZCNT32);

  def_builtin (MASK_BMI, "__builtin_ia32_lzcnt64",
               ulli_ftype_ulli, IX86_BUILTIN_LZCNT64);

  def_builtin (MASK_BMI, "__builtin_ia32_tzcnt16",
               sint_ftype_sint, IX86_BUILTIN_TZCNT16);

  def_builtin (MASK_BMI, "__builtin_ia32_tzcnt32",
               uint_ftype_uint, IX86_BUILTIN_TZCNT32);

  def_builtin (MASK_BMI, "__builtin_ia32_tzcnt64",
               ulli_ftype_ulli, IX86_BUILTIN_TZCNT64);
}
