...
# if !defined(_HOST32_OR_64) && !defined(_WHIRL_HOST64_TARGET64)
...
# if defined(_TARGET32_OR_64) && !defined(_USE_FOLD_DOT_f)
...
# elif defined(_TARGET_LITTLE_ENDIAN) && defined(_TARGET32_OR_64)  && defined(_USE_FOLD_DOT_f) 
# define SHIFT_ARITH_ARG(VAR,TYPE)                                             \
        if (TYPE == Integer_1 ||                                               \
            TYPE == Integer_2 ||                                               \
            TYPE == Integer_4 ||                                               \
