...
//mu-coderep map type
typedef pair< BB_LOOP *, BOOL > wnInfoType;
typedef pair< set<WN *> , wnInfoType > wnSetPairType;
typedef map<CODEREP *, wnSetPairType > crWNSetMapType;
typedef crWNSetMapType::iterator crWNSetMapItrType;
...
private:
  ...
  crWNSetMapType _crWNSetMap;

  //for statistics, emitted only under trace
  unsigned long long _nCUDV;
  unsigned long long _nCUDZVV;
  unsigned long long _nTopCUDV;
  unsigned long long _nTopCUDVSaved;
  unsigned long long _nTopCUDVDirect;

  unsigned long long _totBB ; // Total No of BBs in CFG
  unsigned long long _totStmt; // Total No of Stmts in CFG
  unsigned long long _totPhi ;  // Total No of Phis in CFG
  unsigned long long _totPhiInBB ; // Total No of Phis in a BB
  unsigned long long _totChi ;  // Total No of Chis in CFG
  unsigned long long _totZeroVerPhi ; // Total No of ZeroVerPhis in CFG
  unsigned long long _totZeroVerPhiInBB ; // Total No of ZeroVerPhis in a BB
  unsigned long long _totChiInBB ; // Total No of Chis in a BB
  unsigned long long _maxPhiInBB ; // Max Total No of Phis in a BB
  unsigned long long _maxChiInBB ; // Max Total No of Chis in a BB
  unsigned long long _maxZeroVerPhiInBB ; // Max Total No of 0-ver phis in a BB
  unsigned long long _noOfMatchedStmt ;
  unsigned long long _noOfMatchedChi ; 
  unsigned long long _noOfMatchedPhi ;
  // for statistics
  ...
  void FindMatchingChiDefPhiOpndUse(CODEREP *, BB_NODE *, ZeroVersionPhiType& );
  void StoreDefsForZeroVersionVariables(void);
  ...
  void Compute_use_def_phi_opnd_recursion_unwound(PHI_NODE *,DU_MANAGER *, WN *, BB_NODE *);
