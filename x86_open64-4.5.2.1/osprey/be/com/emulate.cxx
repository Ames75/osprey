  ...
  if (Is_Integer_Constant(pow))
  {
	...
	if (Fast_Exp_Allowed)
	{
	  ...
	  exp = build_mult_tree(block, type, xN, absN);
          /* exp may be null for extreme values of absN 
           * (escaped from above checks or result of
...

  {
    ...
    */
	...
	( WN_intrinsic(tree) == INTRN_F8ACOS ||
	  ...
	  WN_intrinsic(tree) == INTRN_F8EXPM1 ||
	  WN_intrinsic(tree) == INTRN_F4EXPM1 ||
	  ...
	  WN_intrinsic(tree) == INTRN_F8VEXPM1 ||
	  WN_intrinsic(tree) == INTRN_F4VEXPM1 ||
      ...
      case INTRN_F8EXPM1:  st = Gen_Intrinsic_Function(ty, "fastexpm1"); break;
      case INTRN_F4EXPM1:  st = Gen_Intrinsic_Function(ty, "fastexpm1f"); break;
	...
	break;
      case INTRN_F8VEXPM1: 
	st = Gen_Intrinsic_Function(ty, "vrda_expm1");
	vector_call_check_constant_stride = TRUE;
	break;
      case INTRN_F4VEXPM1: 
	st = Gen_Intrinsic_Function(ty, "vrsa_expm1f");
	vector_call_check_constant_stride = TRUE;
	break;
      case INTRN_F8VLOG: 
