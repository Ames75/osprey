...
void Generate_Opteron (void)
{
  ...
  Instruction_Group( "vector cvt f16c",
		     TOP_vcvtph2ps,
		     TOP_vcvtph2psx,
		     TOP_vcvtph2psxx,
		     TOP_vcvtph2psxxx,
 ...
 Instruction_Group("bm andn reg opnd",
                     TOP_andn32,
                     TOP_andn64,
                     TOP_UNDEFINED);
  Any_Operand_Access_Time(0);
 ...
 Instruction_Group("bm andn mem opnd",
                     TOP_andnx32,
                     TOP_andnxx32,
                     TOP_andnxxx32,
                     TOP_andnx64,
  ...
  Instruction_Group("bm mem modes",
                    TOP_blcfillx32,
                    TOP_blcfillxx32,
                    TOP_blcfillxxx32,
                    TOP_blcfillx64,
