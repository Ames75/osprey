...
extern BOOL Target_BMI; 
extern BOOL Target_TBM; 
...
#define Is_Target_BMI()		(Target_BMI == TRUE) 
#define Is_Target_TBM()		(Target_TBM == TRUE) 
...
#define Is_Target_F16C()        (Target_F16C == TRUE)
