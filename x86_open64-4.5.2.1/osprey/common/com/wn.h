...
#ifdef TARG_X8664
extern WN *WN_Create_Constructor (OPERATOR opr,
                                  TYPE_ID rtype,
                                  TYPE_ID desc,
                                  INT32 n,
                                  WN *kids[]);
...
inline WN *
WN_Create_Constructor (OPCODE opc, INT32 n, WN *kids[]) {
    return WN_Create_Constructor (OPCODE_operator(opc), OPCODE_rtype(opc),
            OPCODE_desc(opc), n, kids);
}
#endif
